...
procedure LogTable(Horario: TDateTime; Acao: string; Descricao: string = '');
...
var
  ...
  CaminhoPasta: string;
begin
  CaminhoPasta := 'C:\MemoCash Web\ManutencaoTabelas\Log\';
 ...
 { if not IP.IsEmpty then
  ...
  LogText := ' [' + Acao + '] ' +LogText + ' ' + Descricao;
